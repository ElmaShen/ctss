...
/**
 * 【程式名稱】: AnnounceSetController <br/>
 * 【功能名稱】: 公告訊息設定 Controller<br/>
 * 【功能說明】: For 公告訊息設定 使用<br/>
 * 【建立日期】: 2017/08/11 <br/>
 * 【異動紀錄】: <br/>
 * <br/>
 *
 ...
 */
@Controller
public class AnnounceSetController {

    private static Logger logger = Logger.getLogger(AnnounceSetController.class);
     ...
     */
    @RequestMapping(value = "/admin/announceSet", method = RequestMethod.GET)
    @AdminAudit
    public String announceSet(Locale locale, Model model, @RequestParam(value="userPlaceId", required=false) String userPlaceId) throws Exception {
