            ...
            $.each($.jqx.elements, function () {
                ...
                proto.setup = function () {
                    ...
                    var createInstance = function (defaultSettings) {
                        var isPlugin = false;
                        if (name === "jqxDragDrop" || name === "jqxPopover" || name === 'jqxWindow' || name === "jqxSortable" || name === "jqxDraw" || name === "jqxValidator") {
                            isPlugin = true;
                        ...
                        if (name === "jqxChart" || name === "jqxMenu" || name === "jqxToolBar") {
                        ...
                        if (!isPlugin) {
                            ...
                            if (name === "jqxCheckBox" || name === "jqxBulletChart" || name === "jqxRangeSelector" || name == "jqxPopover" || name === "jqxRadioButton" || name === "jqxChart" || name === "jqxTooltip" || name === "jqxGauge" || name == "jqxLinearGauge" || name == "jqxExpander" || name == "jqxNavigationBar") {
